...
def test_alltoall_single(gpu_info, byte_ranges, step_factor, datatypes, memory_types, request, subtests):
...
@pytest.mark.mpi
def test_alltoall_mpi(gpu_info, byte_ranges, step_factor, datatypes, request, subtests):
    timeout = request.config.getoption("--test-timeout")
