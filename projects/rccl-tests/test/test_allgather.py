...
def test_allgather_single(gpu_counts, byte_ranges, step_factor, datatypes, memory_types, request, subtests):
...
@pytest.mark.mpi
def test_allgather_mpi(gpu_counts, byte_ranges, step_factor, datatypes, request, subtests):
    timeout = request.config.getoption("--test-timeout")
