...
EXECUTABLE = "reduce_perf"


def test_reduce_single(gpu_counts, byte_ranges, step_factor, ops, datatypes, memory_types, request, subtests):
...
@pytest.mark.mpi
def test_reduce_mpi(gpu_counts, byte_ranges, step_factor, ops, datatypes, request, subtests):
    timeout = request.config.getoption("--test-timeout")
