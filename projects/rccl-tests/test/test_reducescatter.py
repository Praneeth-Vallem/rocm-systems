...
def test_reducescatter_single(gpu_counts, byte_ranges, step_factor, ops, datatypes, memory_types, request, subtests):
...
@pytest.mark.mpi
def test_reducescatter_mpi(gpu_counts, byte_ranges, step_factor, ops, datatypes, request, subtests):
    timeout = request.config.getoption("--test-timeout")
